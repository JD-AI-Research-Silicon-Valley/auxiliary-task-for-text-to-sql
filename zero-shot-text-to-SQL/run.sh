...
#CUDA_VISIBLE_DEVICES=$GPU_ID python3 train.py -start_checkpoint_at 30 -split_type "incell" -epochs 45 -global_attention "general" -fix_word_vecs -dropout 0.5 -score_size 64 -attn_hidden 64 -rnn_size 250 -co_attention -embd "$DATA_DIR" -data "$SAVE_PATH" -save_dir "$SAVE_PATH"   >out-train
