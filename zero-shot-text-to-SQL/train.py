...
def train_model(model, train_data, valid_data, fields, optim):
    ...
    train_loss = table.Loss.TableLossCompute(opt.agg_sample_rate, smooth_eps=model.opt.smooth_eps)
    if torch.cuda.is_available():
        train_loss=train_loss.cuda()
    valid_loss = table.Loss.TableLossCompute(opt.agg_sample_rate, smooth_eps=model.opt.smooth_eps)
    if torch.cuda.is_available():
        valid_loss=train_loss.cuda()
