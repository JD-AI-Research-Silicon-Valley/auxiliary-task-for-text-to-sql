def model_opts(parser):
    ...
    # Model options
    # Embedding Options
    parser.add_argument('-use_type', type=str, default="nouse", help="To use type")

    parser.add_argument('-word_vec_size', type=int, default=300,
                        help='Word embedding for both.')
    parser.add_argument('-ent_vec_size', type=int, default=10,
                        help='POS embedding size.')
    parser.add_argument('-type_vec_size', type=int, default=20,
                        help='POS embedding size.')

    parser.add_argument('-elmo_path',type=str, default='/media/DataStor/shuaichen/data_model/wikisql/annotated_ent/elmp_embeddings')
...
def train_opts(parser):
    ...
    parser.add_argument('-embd', default='',
                        help="""Path prefix to embedding folder""")
    ...
    parser.add_argument('-update_word_vecs_after', type=int, default=10,#10
    ...
    parser.add_argument('-optim', default='adam',#'rmsprop',
                        choices=['sgd', 'adagrad',
    ...
    # learning rate
    parser.add_argument('-learning_rate', type=float, default=0.001,#0.002,
...
def translate_opts(parser):
    ...
    parser.add_argument('-save_path', default='',
                        help='Path to processed data and devbest')

    parser.add_argument('-unseen_table', type=str, default="full", help="To test model on unseen tables only")
